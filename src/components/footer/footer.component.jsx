                ...
                <div className="wbus-ssr2271645">
                        ...
                        <div>
                            ...
                            <div className="wbus-ssr2271660">
                                <a aria-label="quick access to our Facebook account" href="#" target="_blank" rel="noreferrer"></a>
                                ...
                                <a aria-label="quick access to our instagram account" className="wbus-ssr2271669 wbus-ssr2271670" href="#" target="_blank" rel="noreferrer" style={{marginRight:"0"}}></a>
                                    ...
                                    <div className="wbus-ssr2271651">
                                        <p>Securities trading is offered to self-directed customers by SF Capital Market Financial LLC, a broker dealer registered with the Securities and Exchange Commission (SEC). SF Capital Market Financial LLC is a member of the Financial Industry Regulatory Authority 
                                            ...
                                            The New York Stock Exchange (<a aria-label="quick access to NYSE membership introduction" href="https://www.nyse.com/markets/nyse/membership" target="_blank" rel="noreferrer">NYSE</a>), 
                                            <a aria-label="quick access to Nasdaq membership introduction" href="http://www.nasdaqtrader.com/Trader.aspx?id=Membership" target="_blank" rel="noreferrer">NASDAQ</a> 
                                            and Cboe EDGX Exchange, Inc (<a aria-label="quick access to CBOE membership introduction" href="https://www.cboe.com/us/equities/membership/" target="_blank" rel="noreferrer">CBOE EDGX</a>).
                                        </p>
                                        <p>SF Capital Market Financial LLC is a member of SIPC, which protects securities customers of its members up to $500,000 (including $250,000 for claims for cash). An explanatory brochure is available upon request or at 
                                            <a aria-label="quick access to SIPC website" href="https://www.sipc.org/" target="_blank" rel="noreferrer noopener">www.sipc.org</a>. 
                                            Our clearing firm, Apex Clearing Corp., has purchased an additional insurance policy.. </p><p>Our clearing firm Apex Clearing Corp has purchased an additional insurance policy. 
                                        ...
                                        <p>
                                            Cryptocurrency execution and custody services are provided by Apex Crypto LLC (NMLS ID 1828849) through a software licensing agreement between Apex Crypto LLC and SF Capital Market Pay LLC. Cryptocurrency trading is offered through an account with Apex Crypto. Apex Crypto is not a registered broker-dealer or FINRA member and your cryptocurrency holdings are not FDIC or SIPC insured. Please ensure that you fully understand the risks involved before trading. Not all coins provided by Apex Crypto LLC and SF Capital Market Pay LLC are available to New York residents. Please visit  
                                            <a aria-label="read crypto trading risk disclosures" href="#" target="_blank" rel="noreferrer noopener">www.sfcapitalmarket.com/cryptocurrency </a>  to see a list of crypto available to trade.
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            Options trading entails significant risk and is not appropriate for all investors. Option investors can rapidly lose the value of their investment in a short period of time and incur permanent loss by expiration date. Losses can potentially exceed the initial required deposit. You need to complete an options trading application and get approval on eligible accounts. Please read the 
                                            <a aria-label="quick link to read Characteristics and Risks of Standardized Options agreement" href="https://www.theocc.com/getmedia/a151a9ae-d784-4a15-bdeb-23a029f50b70/riskstoc.pdf" target="_blank" rel="noreferrer noopener">Characteristics and Risks of Standardized Options</a> 
                                            before trading options.
                                        </p>
                                        <p>
                                            No content on the SF Capital Market Financial LLC website shall be considered as a recommendation or solicitation for the purchase or sale of securities, options, or other investment products. All information and data on the website is for reference only and no historical data shall be considered as the basis for judging future trends. 
                                        </p>
                                        <p>
                                        ...
                                        <p>
                                            Free trading of stocks, ETFs, and options refers to $0 commissions for SF Capital Market Financial LLC self-directed individual cash or margin brokerage accounts and IRAs that trade U.S. listed securities via mobile devices, desktop or website products. Relevant regulatory and exchange fees may apply. Please refer to our 
                                            <a aria-label="quick access to read our fee schedule details" href="https://www.sfcapitalmarket.com/pricing" target="_blank" rel="noreferrer noopener">Fee Schedule</a> for more details. 
                                        </p>
                                    </div>
                                    <div className="wbus-ssr2271653">
                                        <div className="wbus-ssr2271654">
                                            ...
                                            <div role="listbox" aria-expanded="true">
                                                <img alt="" src="https://wbstatic.webullfintech.com/v1/webull-us-g/assets/385cb87759961b9d55a45ba6a778c11f.png"/>
                                            </div>
                                        </div>
                                        <div className="wbus-ssr2271657">
                                            © 2022 SF Capital Market Financial LLC, All rights reserved. Member 
                                            <a aria-label="quick access to FINRA Broker Check" href="https://rcheck.finra.org/firm/summary/289063" target="_blank" rel="noreferrer noopener">FINRA</a>/
                                            <a aria-label="quick access to SIPC broker list" href="https://www.sipc.org/list-of-members/?query=webull" target="_blank" rel="noreferrer noopener">SIPC</a>/
                                            <a aria-label="quick access to NYSE membership introduction" href="https://www.nyse.com/markets/nyse/membership" target="_blank" rel="noreferrer noopener">NYSE</a>/
                                            <a aria-label="quick access to Nasdaq membership introduction" href="http://www.nasdaqtrader.com/Trader.aspx?id=Membership" target="_blank" rel="noreferrer noopener">NASDAQ</a>/
                                            <a aria-label="quick access to CBOE membership introduction" href="https://www.cboe.com/us/equities/membership/" target="_blank" rel="noreferrer noopener">CBOE EDGX</a>
                                        </div>
                                    </div>
                                </div>
                            </footer>
                            <img height="1" width="1" style={{display:"none"}} alt="" src="https://insight.adsrvr.org/track/pxl/?adv=mf10ptp&amp;ct=0:3fz9ryo&amp;fmt=3"/>
                        </Container>
    );
}
